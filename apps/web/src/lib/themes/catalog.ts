...
export const defaultThemeId = "standard-accordion" as const;
export const defaultPaletteId = "ocean" as const;

export const availableThemes = [
  "map-only", "mapbox-journey", "standard-spring", "standard-accordion",
