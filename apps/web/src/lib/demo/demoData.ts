...
const aiGeneratedDemo: DemoDataSet = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: '🎁 サプライズディナー',
      date: getDate(0),
      time: '19:30',      location: 'オーシャンビューレストラン',
...
const mapOnlyDemo: DemoDataSet = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: '秋葉原',
      date: getDate(0),
      time: '15:00',      location: '東京都千代田区秋葉原',
      notes: '電気街の買い物',
      created_at: now,
      updated_at: now,
    },
